<div class="panel panel-default" v-if="editing">
    ...
    <div class="panel-footer">
        <div class="level">
        <button class="btn btn-xs btn-success mr-1" @click="editing = true" v-show="! editing">Edit</button>
        <button class="btn btn-xs btn-primary mr-1" @click="update">Update</button>
        <button class="btn btn-xs btn-danger" @click="resetForm">Cancel</button>
        @can('update', $thread)
...
<div class="panel panel-default" v-else>
    ...
    <div class="panel-footer" v-if="authorize('owns', thread)">
        <button class="btn btn-xs btn-success" @click="editing = true">Edit</button>
    </div>
</div>